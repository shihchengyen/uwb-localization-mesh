#!/usr/bin/env python3
"""
Simple MQTT test script for RPi - compatible with older paho-mqtt versions.
"""
...
def on_connect(*args):
    ...
    if len(args) == 4:
        ...
        client, userdata, flags, rc, properties = args
...
def main():
    ...
    # Use simple client initialization (compatible with all versions)
    client = mqtt.Client(client_id="rpi_simple_test")
